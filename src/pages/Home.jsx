...
function Home(){
  ...
  return (
    ...
    >
      ...
      {/* 플로팅 버튼 클릭 시 옵션 버튼들 */}
      {showOptions && (
        <div style={{ position: 'fixed', bottom: '140px', right: '20px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <button
            onClick={handleSellClick}
            style={{ padding: '10px', backgroundColor: '#BCCDF8', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
          >
            물품 판매하기
          </button>
          <button
            onClick={handleAuctionClick}
            style={{ padding: '10px', backgroundColor: '#6286E4', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
          >
            물품 경매하기
          </button>
        </div>
